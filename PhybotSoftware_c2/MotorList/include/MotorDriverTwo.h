#ifndef MOTORDRIVERTWO_H
#define MOTORDRIVERTWO_H
...
public:
     ...
     */
    MotorDriverTwo(uint16_t id,uint16_t canlineid=0);
    ~MotorDriverTwo();
    ...
    void SetPos(float Pos, float Vel, float Cur);
  ...
  private:
    static std::unique_ptr<DataProcess> Process2;
